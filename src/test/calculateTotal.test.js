...
describe('Test calculateTotal function from InvoiceSingle', () => {
 ...
 const invoice={
    items:{
        ...
        expect(()=>calculateTotal(invoice.items)).toThrow('Argument must be array!');
    })
    ...
    it('should throw error, because provided objects inside array dont have expected properties',()=>{
        ...
        expect(()=>calculateTotal(invoice.items)).toThrow('Each item must be an object with "price" and "quantity" properties');
